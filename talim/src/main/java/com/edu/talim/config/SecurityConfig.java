    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/amaliyot-jurnal", "/api/dars-jurnali", "/api/dars-jurnali/{id}", "/api/kurs-ishi-jurnal", "/api/mustaqil-talim-jurnal", "/api/seminar-jurnal").hasAnyRole("BATALYON", "FAKULTET_BOSHLIGHI", "FAKULTET_BOSHLIGHI_ORINBOSARI", "KAFEDRA_BOSHLIGHI", "KURSANT", "OQITUVCHI", "OQUV_BOLIMI_BOSHLIGHI", "SUPER_ADMIN", "TALIM_SIFATI_NAZORAT")
                        .requestMatchers(HttpMethod.GET, "/api/dars-jurnali/mavzular", "/api/mustaqil-talim-topshiriqlar", "/api/mustaqil-talim-topshiriqlar/{id}", "/api/mustaqil-talim-topshiriqlar/holati", "/api/mustaqil-talim-topshiriqlar/yuborish/{topshiriqYuborishId}/javoblar").hasAnyRole("KAFEDRA_BOSHLIGHI", "OQITUVCHI", "SUPER_ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/fanlar", "/api/fanlar/{id}", "/api/groups").hasAnyRole("FAKULTET_BOSHLIGHI", "FAKULTET_BOSHLIGHI_ORINBOSARI", "KAFEDRA_BOSHLIGHI", "OQUV_BOLIMI_BOSHLIGHI", "RAHBARIYAT", "SHAXSIY_XAVFSIZLIK", "SUPER_ADMIN", "TALIM_SIFATI_NAZORAT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/institutdan-chiqishlar", "/api/institutdan-chiqishlar/{id}").hasAnyRole("BATALYON", "FAKULTET_BOSHLIGHI", "FAKULTET_BOSHLIGHI_ORINBOSARI", "INSON_RESURSLARI", "NAVBATCHILIK_QISMI", "OQUV_BOLIMI_BOSHLIGHI", "RAHBARIYAT", "SHAXSIY_XAVFSIZLIK", "SUPER_ADMIN", "TALIM_SIFATI_NAZORAT")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/sutkalik-naryadlar", "/api/sutkalik-naryadlar/{id}").hasAnyRole("BATALYON", "FAKULTET_BOSHLIGHI", "FAKULTET_BOSHLIGHI_ORINBOSARI", "INSON_RESURSLARI", "KAFEDRA_BOSHLIGHI", "KURSANT", "NAVBATCHILIK_QISMI", "OQITUVCHI", "OQUV_BOLIMI_BOSHLIGHI", "RAHBARIYAT", "SHAXSIY_XAVFSIZLIK", "SUPER_ADMIN", "TALIM_SIFATI_NAZORAT")
                        .requestMatchers(HttpMethod.GET, "/api/kasallar", "/api/kasallar/{id}").hasAnyRole("BATALYON", "FAKULTET_BOSHLIGHI", "FAKULTET_BOSHLIGHI_ORINBOSARI", "INSON_RESURSLARI", "KAFEDRA_BOSHLIGHI", "KURSANT", "OQITUVCHI", "OQUV_BOLIMI_BOSHLIGHI", "RAHBARIYAT", "SHAXSIY_XAVFSIZLIK", "SUPER_ADMIN", "TALIM_SIFATI_NAZORAT", "TIBBIY_XIZMAT")
